...
export default class AwsCloudFront {

    constructor(){  
       
        // this.AWS_BASE_URL = `http://localhost:4004/cloudfront`
        this.AWS_BASE_URL = `https://zvmsff2q64.execute-api.us-east-1.amazonaws.com/dev/cloudfront`
    }
