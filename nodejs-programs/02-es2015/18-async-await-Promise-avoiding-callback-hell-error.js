...
const doSerialSums = async () => {
    ...
    try {
        ...
        // error on this line (after operation rejects) - the rest of code in try block is not executed and control goes to catch block
        let result2 = await sum( result, 'hello' );
        console.log( result2 );
        ...
        throw error; // propagate error to the caller of the doSerialSums function
    }
};
